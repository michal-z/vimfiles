...
hi Keyword cterm=NONE gui=NONE guifg=Grey60 guibg=Grey5
hi Pmenu cterm=NONE gui=NONE guifg=Grey40 guibg=Grey10
hi PmenuSel cterm=NONE gui=NONE guifg=Black guibg=DarkGrey
hi Directory cterm=NONE gui=NONE guifg=DarkGreen guibg=Grey5
...
hi String cterm=NONE gui=italic guifg=Grey60 guibg=Grey5
