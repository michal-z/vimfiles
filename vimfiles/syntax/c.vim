...
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		size_t ssize_t off_t wchar_t ptrdiff_t sig_atomic_t fpos_t usize isize
  syn keyword   cType		clock_t time_t va_list jmp_buf FILE DIR div_t ldiv_t
  syn keyword   cType		mbstate_t wctrans_t wint_t wctype_t
endif
if !exists("c_no_c99") " ISO C99
  syn keyword	cType		_Bool bool _Complex complex _Imaginary imaginary
  syn keyword	cType		int8_t int16_t int32_t int64_t i8 i16 i32 i64 i32x4 i32x8 i64x2 i64x4 int8 int16 int32 int64
  syn keyword	cType		uint8_t uint16_t uint32_t uint64_t u8 u16 u32 u64 f32 f64 f32x4 f32x8 f64x2 f64x4 uint8 uint16 uint32 uint64
  if !exists("c_no_bsd")
...
syn keyword	cStorageClass	static register auto volatile extern const fn
if exists("c_gnu")
